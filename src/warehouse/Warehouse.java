...
public class Warehouse {
    ...
    private void addToEnd(int id, String name, int stock, int day, int demand) {
            //sector to add to is last digit of id
            //initial date of last purchase of your new Product should be set to the current day (day).
        int sec = id % 10;
    ...
    public void purchaseProduct(int id, int day, int amount) {
        ...
        for(int i=1; i<=size; i++){
            Product temp = sector.get(i);
            if(id == temp.getId() && temp!=null && amount<=temp.getStock()){
                temp.setLastPurchaseDay(day);
                temp.updateStock((amount * -1));
                temp.updateDemand((amount));
                sector.sink(i);
            }
